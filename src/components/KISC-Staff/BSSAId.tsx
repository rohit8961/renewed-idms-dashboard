...
import image from "../../assets/Kisc staff id card-Photoroom.png";
                ...
                >
                    ...
                    {profileImage && (
                        <img
                            src={profileImage}
                            alt="Profile"
                            className="absolute top-[116px] left-[115px] w-[166px] h-[162px] rounded-full border-2 border-white"
                        />
                    )}
                    ...
                    <div className="absolute top-[285px] left-[75px] text-black text-[12.5px] font-semibold">
                        ...
                        <span>Center: {staffData.center}</span><br />
